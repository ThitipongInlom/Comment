    ...
    <table id="example" class="table table-striped table-bordered table-sm" style="width:100%">
        ...
        <tbody>
            ...
            <tr align="center">
                ...
                <td align="left">
                    <button class="btn btn-sm btn-success" linkto="http://58.82.151.243/Comment{{ $link->link_en }}" onclick="onopenview(this);" data-toggle="tooltip" data-placement="top" title="ลิ้งค์ ภายนอก"><i class="fas fa-external-link-alt"></i></button>
